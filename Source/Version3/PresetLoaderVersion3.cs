...
namespace EdB.PrepareCarefully {
    public class PresetLoaderVersion3 {
        ...
        public BackstoryDef FindBackstory(string name) {
            BackstoryDef matchingBackstory = SolidBioDatabase.allBios.Aggregate(new List<BackstoryDef>(), (acc, bio) => acc.Concat(new[] {bio.adulthood, bio.childhood}).ToList()).Find((BackstoryDef b) => {
            ...
            if (matchingBackstory == null) {
                ...
                matchingBackstory = SolidBioDatabase.allBios.Aggregate(new List<BackstoryDef>(), (acc, bio) => acc.Concat(new[] {bio.adulthood, bio.childhood}).ToList()).Find((BackstoryDef b) => {
